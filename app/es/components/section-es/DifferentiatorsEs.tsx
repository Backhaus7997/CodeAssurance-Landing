...
const differentiators = [
  { text: 'Hecho por ingenieros,', highlight: 'para ingenieros' },
  { text: 'La calidad no es opcional,', highlight: 'se diseña' },
  { text: 'Encontramos bugs', highlight: 'antes que tus usuarios' },
];

export default function DifferentiatorsEs() {
