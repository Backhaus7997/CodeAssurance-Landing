  ...
  return (
    <footer className="relative py-16 px-6 lg:px-16 xl:px-24 border-t border-white/10">
      <div className="w-full" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="flex flex-col items-center" style={{ width: '100%', maxWidth: '1280px', marginBottom: '48px' }}>
        ...
        {/* Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 text-center" style={{ width: '100%', maxWidth: '1280px' }}>
          {/* Company Info */}
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-white/10 flex flex-col items-center justify-center gap-4 text-sm text-gray-600" style={{ width: '100%', maxWidth: '1280px' }}>
          <p>&copy; {new Date().getFullYear()} Code Assurance. All rights reserved.</p>
